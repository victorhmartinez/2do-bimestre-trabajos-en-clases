...
public static Scanner datos = new Scanner(System.in);
    ...
    public static void main(String[] args) {
        ...
        int ciclo,valorCre;             
         totalPa =  descuentoBecas( (ciclo()+valorCreditos()));
        System.out.print("El valor a pagar es: "+totalPa);
    }
    public static double ciclo() {
        System.out.print("Ingrese el ciclo academico: ");
        int ciclo = datos.nextInt();
        double matricula = 700 + ((ciclo - 1) * 10);
        return matricula;
    }
    
    public static double valorCreditos() {
